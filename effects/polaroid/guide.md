...
- AO3 accepts the current hover reveal path, but not the earlier 3D-only flip approach that relied on rejected properties such as `perspective` or `backface-visibility`.
